# -*- coding: utf-8 -*-
#
# ASCII Designer documentation build configuration file, created by
...
htmlhelp_basename = 'ASCIIDesignerdoc'
...
latex_documents = [
  (master_doc, 'ASCIIDesigner.tex', u'ASCII Designer Documentation',
   u'Johannes Löhnert', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'ASCIIDesigner', u'ASCII Designer Documentation',
   author, 'ASCIIDesigner', 'One line description of project.',
   'Miscellaneous'),
]
...
members_to_watch = ['module', 'class', 'function',]
