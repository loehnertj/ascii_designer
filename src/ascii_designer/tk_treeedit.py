...
class TreeEdit(ttk.Treeview):
    ...
    def allow(self, allow):
        ...
        bad_items = [
            item for item in allow if item not in ["add", "addchild", "remove"]
        ]
        if bad_items:
    ...
    @event
    def on_add(after_iid: str, /) -> bool | None:  # type:ignore
    ...
    @event
    def on_add_child(below_iid: str, /) -> bool | None:  # type:ignore
    ...
    @event
    def on_remove(iid: str, /) -> bool | None:  # type:ignore
    ...
    def advance(self, direction: Literal["left", "right", "up", "down"] = "right"):
        """switch to next cell.
    ...
    def advance_left(self, ev: Any = None):
        return self.advance("left")

    def advance_right(self, ev: Any = None):
        return self.advance("right")

    def advance_up(self, ev: Any = None):
        return self.advance("up")

    def advance_down(self, ev: Any = None):
    ...
    def _update_controls(self):
        ...
        if allow:
            ...
            if "addchild" in allow:
                addcbtn = ttk.Button(
                    ctls, text="+>", command=lambda: self.ins_item(child=True)
                )
    ...
    def ins_item(self, ev: Any = None, child: bool = False):
